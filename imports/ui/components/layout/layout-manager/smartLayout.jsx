...
const SmartLayout = (props) => {
        ...
        value: _.defaultsDeep(
          {
            sidebarNavigation: {
              isOpen:
                input.sidebarNavigation.isOpen ||
  ...
  const calculatesMediaBounds = (mediaAreaBounds, slideSize, sidebarSize) => {
    ...
    if (
      !isOpen ||
      (currentSlideNumber === 0 && !hasExternalVideo && !hasScreenShare)
    ) {
      mediaBounds.width = 0;
  ...
  const calculatesLayout = () => {
    ...
    layoutContextDispatch({
      ...
      value: {
        ...
        left: mediaBounds.right + horizontalCameraDiff,
